...
- Paragraph -> `p`
- Bold -> `strong`
- Emphasize -> `em` //italic font
- Sub-script -> `sub`
- Super-script -> `sup`
- Pre-formatted -> `pre` //As it printed on webpage 
...
->Layout	    Does not start on a new line 	    Starts on a new line
->Width	         Takes only as much as needed	     Takes full width of parent
->Can contain	 Only text or inline elements	     Inline & block elements
->Examples	     <span>, <a>, <strong>	              <div>, <p>, <h1>
